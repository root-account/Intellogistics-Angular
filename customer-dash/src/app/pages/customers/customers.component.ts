...
export class CustomersComponent implements OnInit {
  ...
  public Customers$: Observable<ClientscustomersService[]>;
  ...
  ngOnInit(): void {
    this.spinner.show();
    this.loading_msg = "Loading customers ...";
  ...
  getSingleCustomer(user_id):void{
    this.loading_msg = "Loading customer "+user_id;
    this.spinner.show();
    this._customerService.getSingleDriver(user_id).subscribe({
      next: data => {
          this.single_customer.push(data);;
          this.spinner.hide();
          this.loading_msg = "";
          ...
          this.changeDriverForm.value.user_id = data['qoute'].user_id;
